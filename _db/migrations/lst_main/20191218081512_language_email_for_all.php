...
class LanguageEmailForAll extends AbstractMigration
{
    private $langVarList = array();

    public function init()
    {
        $this->langVarList[] = new LangVar("en", "php", "company", "common", "send-email-for-all", " Guten Tag %salutation% %first_name% %last_name%,<br /><br />
...
<br />
");
        $this->langVarList[] = new LangVar("tr", "php", "company", "common", "send-email-for-all", " Guten Tag %salutation% %first_name% %last_name%,<br /><br />
...
<br />
");
        $this->langVarList[] = new LangVar("de", "php", "company", "common", "send-email-for-all", " Guten Tag %salutation% %first_name% %last_name%,<br /><br />
