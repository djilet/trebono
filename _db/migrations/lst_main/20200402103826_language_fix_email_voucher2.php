...
class LanguageFixEmailVoucher2 extends AbstractMigration
{
...
<br />
");
        $this->delLangVarList[] = new LangVar("tr", "php", "company", "common", "send-email-voucher-new", " Guten Tag %salutation% %first_name% %last_name%,<br /><br />
...
<br />
");
        $this->delLangVarList[] = new LangVar("de", "php", "company", "common", "send-email-voucher-new", " Guten Tag %salutation% %first_name% %last_name%,<br /><br />
...
<br />
");
        $this->delLangVarList[] = new LangVar("en", "php", "company", "common", "send-email-food-voucher-new", "
...
<br />
");
        $this->delLangVarList[] = new LangVar("tr", "php", "company", "common", "send-email-food-voucher-new", "
Guten Tag %salutation% %first_name% %last_name%,<br /><br />
wir wünschen Ihnen besonders viel Freude mit Ihrem %product_group%.<br />
Sie bekommen heute von ihrem Arbeitgeber %company name% folgende neue Gutscheine:<br /><br />
...
<br />
");
        $this->delLangVarList[] = new LangVar("de", "php", "company", "common", "send-email-food-voucher-new", "
Guten Tag %salutation% %first_name% %last_name%,<br /><br />
wir wünschen Ihnen besonders viel Freude mit Ihrem %product_group%.<br />
Sie bekommen heute von ihrem Arbeitgeber %company name% folgende neue Gutscheine:<br /><br />
...
<br />
");
        $this->langVarList[] = new LangVar("en", "php", "company", "common", "send-email-voucher-new", " Guten Tag %salutation% %last_name%,<br /><br />
...
<br />
");
        $this->langVarList[] = new LangVar("tr", "php", "company", "common", "send-email-voucher-new", " Guten Tag %salutation% %last_name%,<br /><br />
...
<br />
");
        $this->langVarList[] = new LangVar("de", "php", "company", "common", "send-email-voucher-new", " Guten Tag %salutation% %last_name%,<br /><br />
...
Guten Tag %salutation% %last_name%,<br /><br />
wir wünschen Ihnen besonders viel Freude mit Ihrem %product_group%.<br />
Sie bekommen heute von ihrem Arbeitgeber %company name% folgende neue Gutscheine:<br /><br />
