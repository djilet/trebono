                ...
                if (!is_array($sql) && !$this->_bindInputArray) {
                    ...
                    foreach ($inputarr as $arr) {
                        ...
                        while (list(, $v) = each($arr)) {
                            ...
                            $typ = gettype($v);
                            if ($typ == 'string') //New memory copy of input created here -mikefedyk
                            {
                                $sql .= $this->qstr($v);
                            } else {
                                if ($typ == 'double') {
                ...
                if ($offset <= 0) {
                    ...
                    if ($isaccess) {
                        $sql = preg_replace(
                            ...
                            '\\1 ' . $this->hasTop . ' ' . ((integer)$nrows) . ' ', $sql);
	 ...
	 */
        function AutoExecute(
            ...
            if ($where !== false) {
                ...
                if ($mode == 'UPDATE' || $mode == 2 /* DB_AUTOQUERY_UPDATE */) {
        ...
        function GetActiveRecordsClass(
            ...
            return adodb_GetActiveRecordsClass($this, $class, $table, $whereOrderBy, $bindarr, $primkeyArr, $extra,
                $relations);
        }
        ...
        function UserDate($v, $fmt = 'Y-m-d', $gmt = false)
        {
            ...
            if (($tt === false || $tt == -1) && $v != false) {
                ...
                if ($tt == 0) {
                    ...
                    if ($tt == -1) { // pre-TIMESTAMP_FIRST_YEAR
                    }
                }
            }
