...
class Report extends Plugin
{
    ...
    function properties($msg = '')
    {
        ...
        if ($report->recordCount() == 1) {
            ...
            echo "<td class=\"data1\">", $misc->printVal($report->fields['paginate'], 'yesno',
                array('align' => 'left')), "</td></tr>\n";
        ...
        if (!isset($_REQUEST['report_sql'])) {
            ...
            if (isset($_REQUEST['fromsql']) and $_REQUEST['fromsql'] == 1) {
                ...
                if (preg_match('/^[0-9]+$/', $_REQUEST['sortkey']) && $_REQUEST['sortkey'] > 0) {
                    $orderby = array($_REQUEST['sortkey'] => $_REQUEST['sortdir']);
                } else {
                    $orderby = array();
                }
    ...
    function drop()
    {
        ...
        if ($confirm) {
            ...
            echo "<p>", sprintf($this->lang['strconfdropreport'],
                $misc->printVal($report->fields['report_name'])), "</p>\n";
