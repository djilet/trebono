...
class SpecificProductGroupBonus extends AbstractSpecificProductGroup
{
    /**
    ...
    {
        return PRODUCT__BONUS__ADVANCED_SECURITY;
    }
    ...
    {
        return CONTAINER__RECEIPT__BONUS;
    }
