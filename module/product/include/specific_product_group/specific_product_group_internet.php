...
class SpecificProductGroupInternet extends AbstractSpecificProductGroup
{
    /**
    ...
    public function ValidateReceiptApprove($receipt)
    {
        ...
        */
        ...
        $realAmountApproved = min(
            round($unit - $approvedReceiptAmount, 2),
    ...
    public function GetOptions($receipt)
    {
        ...
        $optionList[] = array(
            "title_translation" => GetTranslation("option-" . OPTION__INTERNET__MAIN__EMPLOYER_GRANT, "product"),
        ...
        $optionCodes = array(OPTION__INTERNET__MAIN__PAYMENT_MONTH_QTY);
            ...
            foreach ($lastReceiptList as $receipt) {
                ...
                if (!isset($employeeMap[$employeeID]["month_map"][$monthMapKey])) {
                    $employeeMap[$employeeID]["month_map"][$monthMapKey] = array(
                        "positive_line" => array(
                            "title" => "Positive",
                            "acc_key" => "acc_internet_subsidy_tax",
                            "amount" => null,
                            "receipt_ids" => [],
                            "legal_receipt_ids" => []
                        ),
    ...
    {
        return PRODUCT__INTERNET__MAIN;
    }

    public function GetAdvancedSecurityProductCode()
    {
        return PRODUCT__INTERNET__ADVANCED_SECURITY;
    }

    /**
     * @param false $employeeID
     *
     * @return array[]|string[]
     */
    public function GetReplacementsList($employeeID = false, $document_date = "")
    {
        ...
        if ($employeeID) {
            ...
            $amountPerMonth = $this->GetUnit($optionReceipt);
    ...
    {
        return CONTAINER__RECEIPT__INTERNET;
    }
